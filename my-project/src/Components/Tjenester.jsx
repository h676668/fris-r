  ...
  return (
    <section id="Tjenester" className="py-24 bg-zinc-50 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        {/* henter Tjenster som er definert i constants + style og animasjon (responsive)*/}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tjenester.map((item, index) => (
            ...
            >
              {/* Bakgrunnsnummer for hvert tjeneste */}
              ...
              <div>
                {/* linje blir lengre når mus peker på den tjenste & sette rød bakgrunn på en av tjenester (bedre style)*/}
              ...
              {/* Hente priser for hvert tjeneste */}
